        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArrivalTime = table.Column<TimeSpan>(type: "time", nullable: false, defaultValueSql: "GETDATE()"),
                    DepartureTime = table.Column<TimeSpan>(type: "time", nullable: false, defaultValueSql: "GETDATE()"),
                    ClassId = table.Column<int>(type: "int", nullable: true),
                    SemesterId = table.Column<int>(type: "int", nullable: true),
                    TeacherId = table.Column<int>(type: "int", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSemesters", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TeacherSemesters_Teachers_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherSemesters_TeacherId",
                table: "TeacherSemesters",
                column: "TeacherId");
